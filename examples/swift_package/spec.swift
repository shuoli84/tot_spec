...
public struct SimpleStruct: Codable {
    ...
    public var i16_value: Int16?
    public var i32_value: Int32?
    public var i64_value: Int64?
    public var decimal_value: Decimal?
    public var bigint_value: Int64?
    ...
    public var base_id: Base.BaseId
    public var page_info: Base.PageInfo?
    public var related_items: [Base.BaseId]?

    public init(bool_value: Bool, i8_value: Int8? = nil, i16_value: Int16? = nil, i32_value: Int32? = nil, i64_value: Int64? = nil, decimal_value: Decimal? = nil, bigint_value: Int64? = nil, string_value: String? = nil, bytes_value: Data? = nil, string_to_string: [String:String]? = nil, key_values: SpecModel.KeyValue? = nil, children_container: SpecModel.Container? = nil, children: [SpecModel.SimpleStruct]? = nil, base_id: Base.BaseId, page_info: Base.PageInfo? = nil, related_items: [Base.BaseId]? = nil) {
        self.bool_value = bool_value
        self.i8_value = i8_value
        self.i16_value = i16_value
        self.i32_value = i32_value
        self.i64_value = i64_value
        self.decimal_value = decimal_value
        self.bigint_value = bigint_value
...
public struct AddResponse: Codable {
    public var result: SpecModel.Number

    public init(result: SpecModel.Number) {
        self.result = result
    }
}
